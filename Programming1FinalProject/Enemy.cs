...
namespace Programming1FinalProject
{
    class Enemy
    {
        ...
        public Enemy(int iPosX, int iPosY, int iID)
        {
            isAlive = true;
            m_iEnemyID = iID;
        ...
        //Defining a getter function to return the ID number of an enemy
        ...
        //Defining a setter function to set enemy ID
        ...
        public void MoveEnemy(int iPlayerX, int iPlayerY, MapTile up, MapTile down, MapTile left, MapTile right)
        {
            ...
            if (isAlive == true)
            {
                ...
                if (bCheckIfPlayerInRange == true)
                {
                    ...
                    up.checkPassableEnemy();
                    down.checkPassableEnemy();
                    left.checkPassableEnemy();
                    right.checkPassableEnemy();
